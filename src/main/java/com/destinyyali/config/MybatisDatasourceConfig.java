package com.destinyyali.config;
...
/**
 * @author <a href="destinyyali"></a>
 * @version 1.0, 2017/11/24
 * @description
 */
@Configuration
// 精确到 mapper 目录，以便跟其他数据源隔离
@MapperScan(basePackages = "com.destinyyali.mapper", markerInterface = MyMapper.class, sqlSessionFactoryRef = "sqlSessionFactory")
